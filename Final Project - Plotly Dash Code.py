...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                html.Div([
                                    dcc.RangeSlider(
                                        ...
                                        step = 1000,
                                        marks = {
                                            0: {'label': '0kg', 'style': {'color': '#0096FF'}},
                                            1000: {'label': '1000kg'},
                                            2000: {'label': '2000kg'},
                                            3000: {'label': '3000kg'},
                                            4000: {'label': '4000kg'},
                                            ...
                                            8000: {'label': '8000kg'},
                                            9000: {'label': '9000kg'},
                                            10000: {'label': '10000kg', 'style': {'color': '#FF0000'}},
                                            },
...
def update_piegraph(site_dropdown):
    if (site_dropdown == 'All Sites' or site_dropdown == 'None'):
        ...
        fig = px.pie(
                data,
                names = 'Class',
                title = 'Total Successful Launches for Site &#8608; '+site_dropdown,
            )
    return fig
...
def update_scattergraph(site_dropdown,payload_slider):
    if (site_dropdown == 'All Sites' or site_dropdown == 'None'):
        ...
        fig = px.scatter(
                ...
                x = "Payload Mass (kg)",
                y = "class",
                title = 'Correlation Between Payload Mass and Launch Success for Site &#8608; '+site_dropdown,
                color="Booster Version Category",
                size='Payload Mass (kg)',
                hover_data=['Payload Mass (kg)']
            )
